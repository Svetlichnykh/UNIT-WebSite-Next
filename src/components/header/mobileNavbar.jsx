      ...
      <div className="bg-[#f9f9f9] relative overflow-x-clip px-2.5">
        <div className="container-fluid ">
          <div className="flex items-center justify-between py-4">
            ...
            <div>
              <nav
                className={`max-h-screen min-h-screen overflow-y-auto bg-[#F9FFFC] absolute transition-all duration-500 ${isMenuActive ? "right-0" : "sm:-right-full -right-[150%]"} top-0 z-50 py-4 px-4`}
              >
                ...
                <ul className="mt-7">
                  ...
                  <div className="flex items-center pt-5">
                    ...
                    <li
                      className={cn(
                        `text-primary-foreground pl-6 flex items-center relative cursor-pointer`,
                      )}
                      onClick={() => {
                        setCartActive(true);
                        setIsMenuActive(false);
