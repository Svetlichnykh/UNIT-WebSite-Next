...
const Offcanvas = ({ setOffcanvaseActive, offcanvaseActive, bg_muted }) => {
  ...
  return (
    <div
      className={cn(
        `w-full min-h-screen h-full bg-primary ${bg_muted} fixed z-40 ${offcanvaseActive ? "top-0 visible " : "-top-[400%] invisible"} left-0 transition-all duration-700`,
      )}
    >
      ...
      <form className="container h-full mx-auto flex justify-center  flex-col">
        <h1 className=" [font-size:_clamp(90px,14vw,200px)] font-extrabold text-secondary-foreground leading-[100%] mb-5">
          Search
        </h1>
