        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 grid-cols-1 items-center pt-[100px] pb-20">
            <div>
              ...
              <h5 className="font-[family-name:var(--family)] xl:text-2xl text-xl font-semibold text-primary-foreground leading-160 pt-2.5 pb-3">
            ...
            <div className="mt-12 lg:mt-0 flex gap-x-10">
              ...
              <div>
                <h5 className="font-[family-name:var(--family)] text-2xl font-extrabold block text-primary-foreground leading-160 ">
                  Address Spain:
                </h5>
            ...
            <div className="mt-12 lg:mt-0 flex gap-x-10">
              <span className="h-[198px] w-[1px] bg-primary block my-2.5"></span>
              <div>
                <h5 className="font-[family-name:var(--family)] text-2xl font-extrabold inline-block text-primary-foreground leading-160 ">
                  Address USA:
                </h5>
                <span className="w-[99px] h-[1px] bg-primary block my-2.5"></span>
          ...
          <div className="py-8 lg:flex justify-between items-center">
            <span className="text-sm text-primary-foreground block">
              Made with Love by <Link href={""}>ThemePerch</Link>{" "}
            </span>
