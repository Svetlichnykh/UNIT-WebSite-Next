  ...
  return (
    <>
      ...
      >
        <div
          onClick={closeModal}
          className="pb-3 font-bold text-end cursor-pointer"
        >
          Close
        </div>
        ...
        <div className="mt-5">
          <p>
            ...
            <span>
              {customerInfo.first_name} {customerInfo.first_name}
            </span>
          </p>
          <p>
          ...
          <p>
            ...
            <span>{customerInfo.house_number}</span>
          </p>
          <p>
            <span className="font-medium">Apartment:</span>{" "}
            <span>{customerInfo.apartment}</span>
          </p>
          <p>
          ...
          <p>
            ...
            <span>{customerInfo.postcode}</span>
          </p>
          <p>
