...
const ServiceCard = ({id, service_name, service_desc, text_muted, link}) => {
    return (
        <div className='px-3 sm:px-0'>
            <OutlineSvgText classnames={`font-[family-name:var(--family)] text-secondary-foreground stroke-secondary-foreground`} classnamesText={"text-secondary-foreground"} text={id}/>
