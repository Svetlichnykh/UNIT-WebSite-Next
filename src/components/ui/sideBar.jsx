        ...
        <div className={`lg:sticky lg:top-16 lg:pb-16 ${order}`}>
            ...
            <div className='pt-17.5'>
                ...
                <div className='flex gap-3 flex-wrap'>
                    {
                        tagList.map(({ id, tag }) => <Link href={""} key={id}> <ButtonOutline className={"font-normal px-2.5 sm:py-[5px] py-[5px] border"}> <span className='text-lg'>{tag}</span> </ButtonOutline> </Link>)
                    }
                </div>
            </div>
