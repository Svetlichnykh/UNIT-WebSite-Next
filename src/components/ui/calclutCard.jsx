...
const CalclutCard = ({ title, isCheckout, submitOrder, setCustomerInfo }) => {
  ...
  const subTotal = products
    ...
    .toFixed(2);
  const totalPrice = (parseFloat(subTotal) + parseFloat(shippingPrice)).toFixed(
    2,
  );
  ...
  }, [isCheckout, products, paymentMehod, totalPrice, setCustomerInfo]);
  ...
  return (
    <div className="border border-primary px-5 pt-5 pb-7.5 sticky top-20">
      ...
      {isCheckout && (
        <div>
          <div className="pt-4 flex items-center justify-between">
            <h5 className="font-bold text-muted-foreground leading-[1.6]">
              Products
            </h5>
            <h5 className="font-bold text-muted-foreground leading-[1.6]">
              Subtotal
              ...
              return (
                <li key={id} className="flex justify-between items-center">
                  <p className=" flex items-center gap-3">
                    ...
                    <span className="uppercase">x {quantity}</span>
                  </p>
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="free-shipping" className="text-lg font-normal ">
                Free Shipping
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="10" id="local-pickup" />
              <Label htmlFor="local-pickup" className="text-lg font-normal ">
                Local Pickup: <span className="font-bold">$10.00</span>
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="20" id="flat-rate" />
              <Label htmlFor="flat-rate" className="text-lg font-normal ">
                Flat rate: <span className="font-bold">$20.00</span>
              </Label>
            </div>
          </RadioGroup>
      ...
      <Button
        onClick={submitOrder}
        asChild
        className="mt-7.5 w-full cursor-pointer"
        size="lg"
      >
        {isCheckout ? (
