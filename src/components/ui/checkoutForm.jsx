        ...
        <form>
            <div className='flex flex-col gap-7.5'>
                <div className='flex flex-col justify-between gap-[22px]'>
                    <Input className="placeholder:text-primary font-medium rounded-none py-[14px] text-lg outline-none border-[1px] border-primary"
                ...
                <Select onOpenChange={setOpen} onValueChange={setCountry}>
                    ...
                    <SelectContent className='rounded-none py-[14px] bg-primary'>
                        <SelectItem value="united-states" className="text-lg font-medium cursor-pointer text-secondary-foreground">United States</SelectItem>
                        <SelectItem value="united-kingdom" className="text-lg font-medium cursor-pointer text-secondary-foreground">United Kingdom</SelectItem>
                        <SelectItem value="bangladesh" className="text-lg font-medium cursor-pointer text-secondary-foreground">Bangladesh</SelectItem>
                    </SelectContent>
                </Select>
