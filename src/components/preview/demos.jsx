  ...
  return (
    <section className="py-25" id="demos">
      <div className="container">
        <div>
          <h1 className="text-center [font-size:_clamp(40px,7vw,90px)] font-extrabold leading-120 text-primary-foreground mb-15">
            Stylish & Flexible <br /> Layouts
          </h1>
          <div className="grid md:grid-cols-2 gap-10">
            {homeDemoData.map(({ id, demo_img, demo_name, link }) => (
              <DemoCard
                key={id}
                demo_img={demo_img}
                demo_name={demo_name}
        ...
        <div className="pt-25">
          ...
          <div className="grid xl:grid-cols-3 md:grid-cols-2 gap-10">
            {innerDemoData.map(({ id, demo_img, demo_name, link }) => (
              <DemoCard
                key={id}
                demo_img={demo_img}
                demo_name={demo_name}
