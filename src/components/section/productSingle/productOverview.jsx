...
const ProductOverview = ({ findProduct }) => {
  const { id, product_name, price, rating, product_overview, product_img } =
    findProduct;
  ...
  return (
    <div>
      <h2 className="[font-size:_clamp(30px,4vw,48px)] font-bold leading-120 text-primary-foreground">
        {product_name}
      </h2>
      <div className="mb-[22px] mt-3 flex justify-between">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          <Rating star={rating} />{" "}
          <span className="font-semibold">(13 reviews)</span>
        </div>
      </div>
      ...
      <div className="flex sm:flex-row flex-col gap-[18px] mt-[45px] sm:max-w-full max-w-56">
        <div className=" px-4 flex items-center justify-center gap-2 border-[2px] border-primary sm:w-full min-h-14 max-w-44">
          <span
            className="cursor-pointer h-full flex justify-center items-center py-3 px-7"
          ...
          <input
            ...
            readOnly
            className="text-2xl font-bold max-w-8 text-center outline-none flex justify-center  border-0 "
          />
          <span
            className="cursor-pointer h-full flex justify-center items-center py-3 px-7"
      ...
      <ul className="mt-[45px]">
        ...
        <li className="text-lg flex gap-2 mb-2.5">
          ...
          <Link
            href={"#"}
            className="relative inline-block after:absolute after:left-0 after:bottom-1 after:w-full after:h-[1px] after:bg-primary hover-underline"
          >
