...
const aboutList = [
  {
    ...
    item_desc:
      "Поможем подобрать подходящий участок, проверим его юридическую безопасность и подготовим документы",
  },
  {
    id: "02",
  ...
  },
  {
    ...
    item_desc:
      "Собственное производство домов, а также сборка прямо на Вашем участке",
  },
  {
    id: "04",
    item: "Отмечаете новоселье",
    item_desc:
      "Поможем с регистрацией дома, бесплатно дадим 2 года сервисного обслуживания и скидки от компаний-партнеров",
  },
];
  ...
  return (
    <section className="pt-20">
      <div className="container-fluid ">
        <SectionTitle
          sectionName={"Зачем"}
          sectionTitle={"Зачем строить свой дом?"}
          sectionDesc={"Если просто можно купить готовый"}
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <text
                          className={
                            "font-[family-name:var(--family)] text-primary-foreground"
                          }
                          x="0%"
                      ...
                      <div className="max-w-[534px]">
                        <h4 className="text-3xl 2sm:text-4xl font-bold leading-135 text-primary-foreground ">
                          {item}
                        </h4>
