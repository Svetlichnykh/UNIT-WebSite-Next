            ...
            <div className="flex lg:flex-row flex-col items-center justify-between gap-[66px]">
              ...
              <div className="max-w-[533px] lg:pt-0 pt-20 lg:pb-0 pb-10">
                ...
                <p className=" text-secondary-foreground">
                  At Architronix, design is our canvas, and spaces are our
                  masterpieces. With a vision for elegance, functionality, and
                  innovation, our creative team curates environments that
                  reflect dreams. From chic urban apartments to countryside
                  estates, we&apos;re committed to sustainable design practices
                  that enrich lives and the planet.
                </p>
                <p className="text-secondary-foreground mt-7">
                  oin us on a journey where every room is a canvas for
                  creativity, and design transcends the ordinary. Together,
                  let&apos;s craft your vision, one design at a time.
                </p>
              </div>
            </div>
          </div>
