...
const Feedback = () => {
  return (
    <section className="container py-20">
      ...
      >
        <h1 className="[font-size:_clamp(48px,7vw,130px)] font-extrabold leading-110 text-white max-w-[600px]">
          Обсудить проект
        </h1>
        <Link href={"/contact"}>
          <ButtonFill
            className={
              "after:left-0 after:bg-secondary text-primary-foreground border-secondary hover:text-secondary-foreground mt-6 md:mt-0"
            }
          >
            {" "}
            Записаться <RightArrow width={"35"} height={"22"} />{" "}
          </ButtonFill>
        </Link>
      </div>
    </section>
