                ...
                <ul>
                  <li>
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Tailored color palettes crafted to complement your style,
                      preferences, and the unique characteristics of your space.
                    </p>
                  </li>
                  <li className="pt-7.5">
                    <h5 className="font-bold">Expert Advice:</h5>
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Consultation with our experienced color specialists who
                      provide insights into the psychological and aesthetic
                  ...
                  <li className="pt-7.5">
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      In-depth analysis of your space, considering lighting,
                      architecture, and existing elements to ensure cohesive and
                  ...
                  <li className="pt-7.5">
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Guidance on coordinating colors with existing materials,
                      furniture, and decor elements to achieve a unified and
                      polished look.
                    </p>
                  </li>
                  <li className="pt-7.5">
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Incorporation of current design trends while ensuring a
              ...
              <div className="pt-12.5">
                ...
                <ul>
                  <li>
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Reach out to our team and express your interest in a Color
                      Consultation.
                    </p>
                  </li>
                  <li className="pt-7.5">
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      A preliminary discussion to understand your goals,
                      preferences, and any specific challenges you&apos;re
                      facing with your space.
                    </p>
                  </li>
                  <li className="pt-7.5">
                    <h5 className="font-bold">Personalized Color Plan:</h5>
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Depending on your location and preference, we offer
                      on-site or virtual consultations to assess your space.
                    </p>
                  </li>
                  <li className="pt-7.5">
                    <h5 className="font-bold">Follow-Up Support:</h5>
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Our consultants develop a personalized color plan with
                      detailed recommendations and visual representations.
                    </p>
                  </li>
                </ul>
              </div>
              <strong className="mt-12.5 block">
                Enhance your surroundings with the transformative impact of
                carefully chosen colors. Let Architronix bring your vision to
                life through our expert Color Consultation services.
              </strong>
            </div>
