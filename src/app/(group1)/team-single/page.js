          ...
          <div className="grid xl:grid-cols-[auto_538px] lg:grid-cols-[auto_350px] md:grid-cols-[auto_400px] 2xl:gap-[132px] gap-16 items-start">
            <div>
              <div className="mb-12.5">
                ...
                <p>
                  Russell Otten, the Interior Alchemist at Architronix, adds a
                  touch of magic to spaces. With over a decade of experience,
                  Russell blends artistic flair with a deep understanding of
                  client aspirations.
                </p>
              </div>
                ...
                <ul>
                  <li>
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      ...
                      capturing the essence of each client&apos;s persionality
                      and translating it into a space that feels uniquely
                      theirs.
                    </p>
                  </li>
                  <li className="pt-7.5">
              ...
              <div className="pt-20">
                ...
                <ul>
                  <li>
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Russell holds a Master&apos;s in Interior of the Design
                      from Architronix University of Belgium.
                    </p>
                  </li>
                  <li className="pt-7.5">
              ...
              <div className="pt-20">
                ...
                <ul>
                  <li>
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Russell Otten&apos;s work at Architronix has been
                      feeatured in Design Excellence Magazine, earning him the
                      Interior Alchemist title.
                    </p>
                  </li>
                </ul>
              </div>
