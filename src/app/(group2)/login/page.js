    ...
    <section className="py-8.5 lg:py-17.5">
      <div className="container">
        <div
          ...
          style={{
            backgroundImage: `url(${feedback_bg.src})`,
        ...
        >
          <div className="login-page-txt flex flex-col justify-center px-3.5 lg:px-7.5 py-8.5 lg:py-17.5">
            <Link className="py-0 inline-flex" href="/">
            ...
            <p className="text-secondary mt-7.5 mb-0">
              Crafting Architectural Designing and Masterpieces Interior
              Wonders, Join us on a journey marked by accolades and distinctions
              as we carve our path in the world of design.
            </p>
            <div className="login-page-copyright mt-7.5">
              <p className="text-secondary mb-0">
                &copy; {currentYear}, Architronix, All Rights Reserved
              </p>
            </div>
          </div>
          <div className="login-page-form bg-secondary h-full flex flex-col justify-center px-3.5 lg:px-7.5 py-8.5 lg:py-17.5">
            <form id="checkOutForm" className="contact-form">
              <div className="mb-3.5 lg:mb-7.5">
                <label className="text-primary mb-1" htmlFor="userName">
              ...
              <div className="mb-3.5 lg:mb-7.5">
                <label className="text-primary mb-1" htmlFor="usrerPassword">
                  Password*
                </label>
                <InputFiled
                  id={"usrerPassword"}
              ...
              <div className="flex items-center space-x-2">
                <input
                  id="checkboxRe"
                  type="checkbox"
                  className="border-primary accent-primary rounded-lg h-[18px] w-[18px]"
                />
                <label className="text-primary" htmlFor="checkboxRe">
                  Remember Me
                </label>
              </div>

              <div className="w-full mt-3.5 lg:mt-7.5">
                <ButtonOutline2 className={"w-full"}>
                  {" "}
                  Log In <RightArrow height={"22"} width={"35"} />
                </ButtonOutline2>
              </div>
