          ...
          <div className='login-page-form bg-secondary h-full flex flex-col justify-center px-3.5 lg:px-7.5 py-8.5 lg:py-17.5'>
            <form id="checkOutForm" className="contact-form">
              <div className='mb-3.5 lg:mb-7.5'>
                <label className="text-primary mb-1" htmlFor="userName">Username*</label>
                <InputFiled id={"userName"} type={"text"} className={'bg-white'} />
              </div>
              <div className='mb-3.5 lg:mb-7.5'>
                <label className="text-primary mb-1" htmlFor="userName">Email*</label>
                <InputFiled id={"userName"} type={"email"} className={'bg-white'} />
              </div>
              <div className='mb-3.5 lg:mb-7.5'>
                <label className="text-primary mb-1" htmlFor="usrerPassword">Password*</label>
                <InputFiled id={"usrerPassword"} type={"password"} className={'bg-white'} />
              </div>
              <div className='mb-3.5 lg:mb-7.5'>
                <label className="text-primary mb-1" htmlFor="usrerPassword">Confirm Password*</label>
                <InputFiled id={"usrerPassword"} type={"password"} className={'bg-white'} />
              </div>

              <div className='w-full mt-3.5 lg:mt-7.5'>
                <ButtonOutline2 className={"w-full"}> Register <RightArrow height={"22"} width={"35"} /></ButtonOutline2>
              </div>

              <p className="create-account text-center mt-3.5 mb-0">
                <span> Already have an account? </span>
                <Link href={'/login'} className='underline'>SignIn</Link>
              </p>
            </form>
          </div>
        </div>
